...
def recurrent_neural_network(x, current_batch_size):
	...
	lstm_layer_3_1, lstm_layer_3_1_states = tf.nn.dynamic_rnn(lstm_cell_3_1, conv2_split1, dtype=tf.float32, scope='lstm_layer_3_1')
	lstm_layer_3_2, lstm_layer_3_2_states = tf.nn.dynamic_rnn(lstm_cell_3_2, conv2_split2, dtype=tf.float32, scope='lstm_layer_3_2')
	lstm_layer_3_3, lstm_layer_3_3_states = tf.nn.dynamic_rnn(lstm_cell_3_3, conv2_split3, dtype=tf.float32, scope='lstm_layer_3_3')
	lstm_layer_3_4, lstm_layer_3_4_states = tf.nn.dynamic_rnn(lstm_cell_3_4, conv2_split4, dtype=tf.float32, scope='lstm_layer_3_4')
	lstm_layer_3_5, lstm_layer_3_5_states = tf.nn.dynamic_rnn(lstm_cell_3_5, conv2_split5, dtype=tf.float32, scope='lstm_layer_3_5')
	lstm_layer_3_6, lstm_layer_3_6_states = tf.nn.dynamic_rnn(lstm_cell_3_6, conv2_split6, dtype=tf.float32, scope='lstm_layer_3_6')
	lstm_layer_3_7, lstm_layer_3_7_states = tf.nn.dynamic_rnn(lstm_cell_3_7, conv2_split7, dtype=tf.float32, scope='lstm_layer_3_7')
